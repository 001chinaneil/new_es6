...
!function (a) {
  ...
  function b(a) {
    ...
    return d.bind(e, "DOMContentLoaded", c), d.bind(e, "readystatechange", c), d.bind(a, "load", c), b;
      ...
      f = [];b.isReady = !1, "function" == typeof define && define.amd ? (b.isReady = "function" == typeof requirejs, define("doc-ready/doc-ready", ["eventie/eventie"], d)) : a.docReady = d(a.eventie);
}(undefined), function () {
  function a() {}function b(a, b) {
    ...
    return a;
  }) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = a : this.EventEmitter = a;
  ...
  function b(a) {
    ...
    function d(a) {
      if ("string" == typeof a && (a = document.querySelector(a)), a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && a.nodeType) {
        var d = f(a);if ("none" === d.display) return c();var e = {};e.width = a.offsetWidth, e.height = a.offsetHeight;for (var k = e.isBorderBox = !(!j || !d[j] || "border-box" !== d[j]), l = 0, m = g.length; m > l; l++) {
          var n = g[l],
              o = d[n];o = h(a, o);var p = parseFloat(o);e[n] = isNaN(p) ? 0 : p;
            ...
            w = k && i,
            x = b(d.width);x !== !1 && (e.width = x + (w ? 0 : q + u));var y = b(d.height);return y !== !1 && (e.height = y + (w ? 0 : r + v)), e.innerWidth = e.width - (q + u), e.innerHeight = e.height - (r + v), e.outerWidth = e.width + s, e.outerHeight = e.height + t, e;
      }
    }function h(a, b) {
      if (e || -1 === b.indexOf("%")) return b;var c = a.style,
        ...
        j = a("boxSizing");return function () {
      if (j) {
        var a = document.createElement("div");a.style.width = "200px", a.style.padding = "1px 2px 3px 4px", a.style.borderStyle = "solid", a.style.borderWidth = "1px 2px 3px 4px", a.style[j] = "border-box";var c = document.body || document.documentElement;c.appendChild(a);var d = f(a);i = 200 === b(d.width), c.removeChild(a);
      }
    }(), d;
  ...
  function c(a, b) {
    ...
    var i = document.createElement("div"),
        j = c(i, "div");g = j ? c : f;
  } else g = e;"function" == typeof define && define.amd ? define("matches-selector/matches-selector", [], function () {
    return g;
  }) : window.matchesSelector = g;
}(undefined, Element.prototype), function (a) {
  function b(a, b) {
    for (var c in b) {
      a[c] = b[c];
    }return a;
  ...
  function b(a, b) {
    ...
    function q(a, c) {
      ...
      m = "object" == (typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) ? function (a) {
