...
var app = new Vue({
  ...
  data: {
    ...
    hostMap: [{
      ...
      uphosts: ['http://up.qiniu.com', 'http://upload.qiniu.com', 'https://up.qbox.me', 'https://upload.qbox.me']
    }, {
      zone: 'z1',
      zoneZh: '华北',
      ...
      uphosts: ['http://up-z1.qiniu.com', 'http://upload-z1.qiniu.com', 'https://up-z1.qbox.me', 'https://upload-z1.qbox.me']
    }, {
      zone: 'z2',
      zoneZh: '华南',
      ...
      uphosts: ['http://up-z2.qiniu.com', 'http://upload-z2.qiniu.com', 'https://up-z2.qbox.me', 'https://upload-z2.qbox.me']
    }, {
      zone: 'na0',
      zoneZh: '北美',
      ...
      uphosts: ['http://up-na0.qiniu.com', 'http://upload-na0.qiniu.com', 'https://up-na0.qbox.me', 'https://upload-na0.qbox.me']
    }],
  ...
  methods: {
    ...
    uploadTest: function uploadTest() {
      ...
      this.post({
        ...
        finally: function _finally(code, xhr) {
    ...
    mockDate: function mockDate(size) {
    ...
    randomBase64: function randomBase64() {
    ...
    switchZone: function switchZone(zone) {
    ...
    formateHeader: function formateHeader(headers) {
      var list = [];
    ...
    formateLog: function formateLog(code, xhr) {
